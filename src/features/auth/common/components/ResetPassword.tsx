...
import type {  FloatingInputProps } from "../../types/form.types";
    ...
    >
      ...
      >
        <h1 className="text-xl font-bold text-gray-900 mb-1">
          Change <span className="text-blue-600">ShelfShare</span> Password
        </h1>
      </motion.div>
      ...
      >
        ...
        <AnimatedField name="newPassword" type="password" label="New Password" />
        <AnimatedField name="confirmPassword" type="password" label="Confirm Password" />
          {/* Verify BUTTON */}
          <motion.button
